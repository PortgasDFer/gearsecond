            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="/dvp" method="POST" name="producto" id="agregar">
                    ...
                    <div class="form-group row">
                      <label for="name" class="col-md-4 col-form-label text-md-right">Buscar producto</label>
                      <div class="col-md-6">
                          <select id="idcliente" name="codebar" class="js-example-basic-single" style="width: 100%" onchange="obtener_datos(this.value)">
