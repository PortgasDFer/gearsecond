    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="/registrarDeudor" enctype="multipart/form-data">
                    @csrf
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Folio venta</label>
                            <div class="col-md-6">
                                <input id="codebar" type="text" class="form-control" name="olao" value="{{$folio}}" disabled="">
